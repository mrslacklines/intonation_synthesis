...
datasetNameIdx = 'datasetName'
datasetTypeIdx = 'datasetType'
classNamesIdx = 'classNames'
inputFeaturesNamesIdx = 'inputFeaturesNames'
layerNamesIdx = 'layerNames'
inverseOptimizationIdx = 'inverseOptimization'
adversarialExamplesIdx = 'adversarialExamples'
inputLayerIdx = 'inputLayer'
groundTruthIdx = 'groundTruth'

rawValueIdx = 'rawValue'
saliencyMapIdx = 'saliencyMap'
filterImportanceIdx = 'filterImportance'
filterSaliencyIdx = 'filterSaliency'
filterMaskIdx = 'filterMask'
filterLossImpactIdx = 'filterLossImpact'
filterClusterIdx = 'filterCluster'
    ...
    def drawPoint(i, channelIdx=None):
        ...
        if showSaliency:
            ...
            if i < rawValues.shape[0] - 1:
                ...
                heightStride = heightDiff / widthDiff if widthDiff else 0
...
if __name__ == "__main__":
    ...
    url = "http://localhost:5000/viz/api/"
    ...
    while True:
        ...
        if batchMode:
            ...
            gt = json.loads(response.content.decode("utf-8"))["y"]
            plotExample = gt
